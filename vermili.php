...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">  <tr> <td>&nbsp;</td> </tr>
  ...
  <tr class="css10">
    <td height="20" colspan="3" align="left" valign="middle" bgcolor="#68A3C3" class="css12n">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Consulta de militante</td>  
  </tr>
...
$BUSCAR=$_POST['BUSCAR'];
if(!$BUSCAR){ $BUSCAR=0; }
$rese = mysql_query("SELECT * FROM militante a , categoria_militante b , parroquia c WHERE a.ci_mte='$BUSCAR' and b.cod_cmte=a.cod_cmte and a.id_parroquia=c.id ORDER BY a.ci_mte DESC ;", $DB); 
...
<?php } else if((!$_POST['Buscar']) && ($_GET['ci'])){ $ci=$_GET['ci'];?>
<?php  $rese = mysql_query("SELECT * FROM militante a , categoria_militante b , parroquia c WHERE a.ci_mte='$ci' and b.cod_cmte=a.cod_cmte and a.id_parroquia=c.id ORDER BY a.ci_mte DESC ;", $DB); 
$rowe = mysql_num_rows($rese);  ?> 

...
<?php $resd = mysql_query("SELECT * FROM curso_detalle a , curso b where a.cod_cso=b.cod_cso ORDER BY cod_csod ");
...
</tr>  <tr> <td height="40" align="center" valign="middle" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE"> <tr> <td width="34%" height="25" align="left" valign="middle" class="css12n">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MÓDULOS</td>
<td width="39%" align="right" valign="middle" class="css12n">&nbsp;</td>
<td align="right" valign="middle" class="css12n"><a href="?seccion=mod" class="css12n">Agregar MÓDULO</a>&nbsp;&nbsp;&nbsp;</td>
</tr></table></td>  </tr>
  <tr>  <td height="17" align="right"  ></td>  
  </tr>  <tr>  <td align="center" valign="top" bgcolor="#FFFFFF" > <table width="800"  border="0" align="center" cellpadding="0" cellspacing="2" > 
<tr bgcolor="#EEEEEE" > <td width="32" align="center" ><b class="css10n">N&ordm;</b></td> 
  ...
  <td width="224" align="center" class="css10n" >Curso o Taller</td>
  ...
  <td width="155" align="center" class="css10n" >Eliminar</td>
...
<td align="center" class="css10"><a href="?seccion=elimod&amp;ci=<?php echo $ldoc[0] ;?>"><img src="imagenes/delete.gif" alt="Ver" border="0"/></a></td>
<td align="center" class="css10"><a href="?seccion=edimod&amp;ci=<?php echo $ldoc[0] ;?>"><img src="imagenes/edit.gif" alt="Editar" border="0"/></a></td>

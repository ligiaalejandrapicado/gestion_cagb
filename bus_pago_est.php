...
<tr>
  <td align="center" valign="middle">CONSULTAR PAGOS DE ESTUDIANTE</td>
...
$resd = mysql_query("SELECT * FROM inscripcion a, curso b, pagos c where 
 a.ci_ste='$BUSCAR' && a.cod_cso=b.cod_cso && c.cod_ico=a.cod_ico  ORDER BY a.cod_ico DESC");
...
<span class="css12n">&nbsp;&nbsp;&nbsp;</span> <span class="css10n">PAGOS REALIZADOS</span></td> 
...
</tr>  <tr> <td height="40" align="center" valign="middle" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE"> <tr> <td width="34%" height="25" align="left" valign="middle" class="css10n">&nbsp;&nbsp;&nbsp;PAGOS REALIZADOS</td>
...
<tr bgcolor="#EEEEEE" > <td width="20" align="center" ><b class="css10n">N&ordm;</b></td> 
  ...
  <td width="446" align="left" bgcolor="#EEEEEE" class="css10n">Nro de Recibo</td>
  <td width="446" align="left" bgcolor="#EEEEEE" class="css10n">Monto</td>
  <td width="446" align="left" bgcolor="#EEEEEE" class="css10n">Fecha de pago</td>
  <td width="446" align="left" bgcolor="#EEEEEE" class="css10n">Comprobante</td>    
  </tr> 
...
<td align="left" bgcolor="#FEFEFE" class="css10"><?php echo $ldoc[22];?></td>
<td align="left" bgcolor="#FEFEFE" class="css10"><?php echo $ldoc[21];?></td>
<td align="left" bgcolor="#FEFEFE" class="css10"><?php echo $ldoc[20];?></td>
<td align="left" bgcolor="#FEFEFE" class="css10">

<a href="imagenpgo.php?id=<?php echo $ldoc[18] ;?>&t=pagos&c=cod_pgo" target="_blank" onClick="window.open(this.href, this.target, 'width=550,height=500,scrollbars=1'); return false;"><img src="imagenes/ver.gif" alt="Ver comprobante #<?php echo  $ldoc[18] ;?>" border="0" /></a>
...
<td align="left" bgcolor="#F1F1F1" class="css10" ><?php echo $ldoc[22];?></td>
<td align="left" bgcolor="#F1F1F1" class="css10" ><?php echo $ldoc[21];?></td>
<td align="left" bgcolor="#F1F1F1" class="css10" ><?php echo $ldoc[20];?></td>
<td align="left" bgcolor="#F1F1F1" class="css10" >&nbsp;</td>
  <? if( $ldoc[10] == "ABIERTO" ) $color='bgcolor="#00FF00"'; else if( $ldoc[10] == "CANCELADO" ) $color='bgcolor="#FF0000"';else if( $ldoc[10] == "CERRADO" ) $color='bgcolor="#00CCFF"';?>

...
<?php $resd = mysql_query("SELECT * FROM militante a, categoria_militante b where a.cod_cmte=b.cod_cmte   ORDER BY a.ci_mte ");
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >  <tr><td><table width="100%"  border="0" cellspacing="0" cellpadding="0">  <tr>  <td align="right"></td></tr>  <tr>  <td height="40" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE">  <tr>  <td width="30%" height="25" align="left" valign="middle" class="css12" ><span class="css12n">&nbsp;&nbsp;&nbsp;MILITANTES</span> </td> 
                ...
                <td width="18%" align="left" valign="middle" class="css12n" ><a href="?seccion=mili">Agregar MILITANTE</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
</tr>  <tr> <td height="40" align="center" valign="middle" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE"> <tr> <td width="34%" height="25" align="left" valign="middle" class="css12n">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MILITANTES</td>
<td width="43%" align="right" valign="middle" class="css12n">&nbsp;</td>
<td width="2%" align="right" valign="middle" class="css12n">&nbsp;</td>
<td width="21%" align="left" valign="middle" class="css12"><a href="?seccion=mili" class="css12n">Agregar MILITANTE</a>&nbsp;&nbsp;&nbsp;</td>
</tr></table></td>  </tr>
...
<tr bgcolor="#EEEEEE" > <td width="40" align="center" ><b class="css10n">N&ordm;</b></td> 
  ...
  <td width="304" align="center" class="css10n" >Sexo</td>
...
<td align="left" class="css10"><?php echo $ldoc[10];?></td> 
<td align="left" class="css10">&nbsp;&nbsp;<?php echo $ldoc[2];?></td>
<td align="left" class="css10"><?php echo $ldoc[3];?></td>
<td align="left" class="css10"><?php echo $ldoc[8];?></td>
...
<td align="center" class="css10"><a href="?seccion=edimili&amp;ci=<?php echo $ldoc[0] ;?>"><img src="imagenes/edit.gif" alt="Editar" border="0"/></a></td>

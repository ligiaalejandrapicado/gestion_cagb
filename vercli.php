...
<tr><td width="134" align="right" valign="middle"><img src="imagenes/vcli.jpg" width="36" height="32" /></td>
    <td width="8">&nbsp;</td>
    <td width="280" align="left">CLIENTE</td>
...
<tr class="css10"><td height="20" colspan="3" align="left" valign="middle" bgcolor="#FFCC00" class="css12n">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Consulta</td>  </tr>
...
<?php if((!$BUSCAR) && ($id)){ ?>
<?php  $rese = mysql_query("SELECT * FROM cliente WHERE id_clie=$id ORDER BY id_clie DESC ;", $DB); 
$rowe = mysql_num_rows($rese);  ?> 

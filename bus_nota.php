...
<tr>
  <td align="center" valign="middle">AGREGAR NOTA A ESTUDIANTE</td>
...
$resd = mysql_query("SELECT c.cod_nta, b.des_csod,c.pts_nta,c.obs_nta  FROM inscripcion a, curso_detalle b, notas c where 
 a.cod_ico=c.cod_ico && a.cod_cso=b.cod_cso && c.cod_csod=b.cod_csod
...
<span class="css12n">&nbsp;&nbsp;&nbsp;</span> <span class="css10n">NOTAS DISPONIBLES PARA MODIFICAR</span></td> 
...
</tr>  <tr> <td height="40" align="center" valign="middle" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE"> <tr> <td width="34%" height="25" align="left" valign="middle" class="css10n">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NOTAS DE ESTUDIANTE </td>
...
<tr bgcolor="#EEEEEE" > <td width="20" align="center" ><b class="css10n">N&ordm;</b></td> 
  <td width="228" align="left" bgcolor="#EEEEEE" class="css10n">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Módulo o Curso</td>    
  <td width="52" align="center" bgcolor="#EEEEEE" class="css10n">Nota</td>
  <td width="285" align="center" bgcolor="#EEEEEE" class="css10n">Observación</td>
  <td align="center" class="css10n" >Opciones</td>
  </tr> 
...
<td align="left" bgcolor="#FEFEFE" class="css10">&nbsp;&nbsp;&nbsp;<?php echo $ldoc[1];?></td>
<td align="center" bgcolor="#FEFEFE" class="css10"><?php echo $ldoc[2];?></td>
<td align="center" bgcolor="#FEFEFE" class="css10"><?php echo $ldoc[3];?>&nbsp;&nbsp;&nbsp;</td>
...
<td align="center" class="css10"><a href="?seccion=edinta&amp;id=<?php echo $ldoc[0] ;?>&ci=<?php echo $BUSCAR ;?>"><img src="imagenes/edit.gif" alt="Editar" border="0"/></a></td>
</tr><?php }  else if ($sw == 1) {  $sw=0;     ?><tr valign="middle"  bgcolor="#F1F1F1" > <td height="15" align="center" class="css10"   ><?php echo $k ;?></td> 
<td align="left" bgcolor="#F1F1F1" class="css10" >&nbsp;&nbsp;&nbsp;<?php echo $ldoc[1];?></td>
  <td align="center" bgcolor="#F1F1F1" class="css10" ><?php echo $ldoc[2];?></td>
  <td align="center" bgcolor="#F1F1F1" class="css10" ><?php echo $ldoc[3];?>&nbsp;&nbsp;&nbsp;</td>

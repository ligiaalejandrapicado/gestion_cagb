...
<?php  $ci=$_GET['ci'];  $id=$_GET['id'];
$sql = "SELECT * FROM inscripcion WHERE cod_ico='$id' ORDER BY cod_ico DESC ";
...
<tr> <td height="40" bgcolor="#EEEEEE" ><table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>  <td width="60" align="right" valign="middle">&nbsp;</td>
      <td width="4"></td>
      <td width="253" align="left" valign="middle" class="css12n">REGISTRO DE PAGO</td>
...
<tr> <td height="5" align="right"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="#F2F2F2">
    ...
    <td width="174" align="left" bgcolor="#F2F2F2" class="css12r"> &nbsp;<?php echo $ci; ?></td>
    <td width="73"></td>
  </tr>
  <tr bgcolor="#F2F2F2">
  ...
  <tr bgcolor="#F2F2F2">
    ...
    <td align="left" bgcolor="#F2F2F2" class="css10"><?php $resdp2 = mysql_query("SELECT * FROM curso where cod_cso='$row[2]' order by cod_cso");
...
$sqls_pgo="Insert Into pagos ( cod_ico,fecha_pgo,monto_pgo,ntra_pgo,com_pgo,obs_pgo ) values ( '" .$id. "','" .$fechap. "','" .$monto. "','" .$ntra. "','" .$data. "','" .$obs. "','" .$tipo. "')"; 
...
mysql_close(); 
 ...
 ?>
<SCRIPT LANGUAGE="javascript">alert('HA SIDO REGISTRADO EL PAGO. POR FAVOR CONSULTE ');location.href = "?seccion=bpgoe";</SCRIPT>
<?php } } ?>
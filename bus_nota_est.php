...
<tr>
  <td align="center" valign="middle">CONSULTAR NOTA DE ESTUDIANTE</td>
...
$resd = mysql_query("SELECT b.des_csod,c.pts_nta,c.obs_nta  FROM inscripcion a, curso_detalle b, notas c where 
...
<span class="css12n">&nbsp;&nbsp;&nbsp;</span> <span class="css10n">NOTAS DISPONIBLES </span></td> 
...
<td align="left" bgcolor="#FEFEFE" class="css10">&nbsp;&nbsp;&nbsp;<?php echo $ldoc[0];?></td>
<td align="center" bgcolor="#FEFEFE" class="css10"><?php echo $ldoc[1];?></td>
...
<td align="left" bgcolor="#F1F1F1" class="css10" >&nbsp;&nbsp;&nbsp;<?php echo $ldoc[0];?></td>
  <td align="center" bgcolor="#F1F1F1" class="css10" ><?php echo $ldoc[1];?></td>

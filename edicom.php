...
if((form.ci.value=="")||(form.ccom.value=="")||(form.nombre.value=="")||(form.dir.value=="")||(form.tel.value=="") || (form.parr.value=="")|| (form.est.value=="") ){
...
<tr> <td height="40" bgcolor="#EEEEEE" ><table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>  <td width="60" align="right" valign="middle">&nbsp;</td>
      <td width="4"></td>
      <td width="253" align="left" valign="middle" class="css12n">MODIFICAR COMITÉ</td>
...
$result3="update comite set cod_ccom='".$ccom."', nom_com='".$nombre."', dir_com='".$dir."', id_parroquia='".$parr."', tel_com='".$tel."', email_com='".$email."' , est_com='".$est."' WHERE ci_com='$ci'";
mysql_query($result3); ?>

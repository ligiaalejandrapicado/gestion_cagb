...
<tr> <td height="40" bgcolor="#EEEEEE" ><table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>  <td width="60" align="right" valign="middle">&nbsp;</td>
      <td width="4"></td>
      <td width="253" align="left" valign="middle" class="css12n">INSCRIPCIÓN</td>
...
<tr> <td height="5" align="right"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <?php if($nrow<=0) {    ?>
  ...
  <tr bgcolor="#F2F2F2">
    <td align="right" bgcolor="#FFFFFF"><input name="datos" type="hidden" id="datos" value="<?=$nrow?>" /></td>
...
$sqls_pgo="Insert Into pagos ( cod_ico,fecha_pgo,monto_pgo,ntra_pgo,com_pgo,obs_pgo,tipo_imagen ) values ( '" .$codigo. "','" .$cfechap. "','" .$monto. "','" .$ntra. "','" .$data. "','" .$obs. "','" .$tipo. "')"; 
...
mysql_close(); 
 ...
 ?>
<SCRIPT LANGUAGE="javascript">location.href = "?seccion=lisinsc";</SCRIPT>
<?php } } ?>
...
<?php $resd = mysql_query("SELECT * FROM estudiante ORDER BY ci_ste ");
...
</tr>  <tr> <td height="40" align="center" valign="middle" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE"> <tr> <td width="34%" height="25" align="left" valign="middle" class="css12n">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ESTUDIANTES</td>
<td width="39%" align="right" valign="middle" class="css12n">&nbsp;</td>
<td align="right" valign="middle" class="css12n"><a href="?seccion=est" class="css12n">Agregar ESTUDIANTE</a>&nbsp;&nbsp;&nbsp;</td>
</tr></table></td>  </tr>
...
<tr bgcolor="#EEEEEE" > <td width="32" align="center" ><b class="css10n">N&ordm;</b></td> 
  ...
  <td width="83" align="center" class="css10n" >Registro</td>
...
<td align="center" class="css10"><a href="?seccion=verest&amp;ci=<?php echo $ldoc[0] ;?>"><img src="imagenes/ver.gif" alt="Ver" border="0"/></a></td>
<td align="center" class="css10"><a href="?seccion=ediest&amp;ci=<?php echo $ldoc[0] ;?>"><img src="imagenes/edit.gif" alt="Editar" border="0"/></a></td>

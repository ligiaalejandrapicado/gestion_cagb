...
if((form.ci.value=="")|| (form.tci.value=="")|| (form.gen.value=="")||(form.cmili.value=="")||(form.nombre.value=="")||(form.dir.value=="")||(form.tel.value=="") || (form.parr.value=="")|| (form.est.value=="") ){
...
<tr><td width="53" align="right" valign="middle">&nbsp;</td>
  <td width="15" align="left" class="css12n">&nbsp;</td>
    <td width="147" align="left" class="css12n">MILITANTE</td>
...
<tr><td> 
  ...
  <tr bgcolor="#F2F2F2">
     <td height="25"  colspan="3" align="center" valign="middle" bgcolor="#68A3C3" >
      ...
      <tr>
          <td align="left" class="css12n">Nuevo Militante</td>
          <td></td>
...
if($rows>0){
?>  <SCRIPT LANGUAGE="javascript"> location.href ="?seccion=mili&men=CI : <?php echo $ci; ?> Ya Existente"; </SCRIPT> <?php } else { ?>
<?php
$cmili=$_POST['cmili'];
$nombre=$_POST['nombre'];
	$dir=$_POST['dir'];
...
$sqls="Insert Into militante (ci_mte, cod_cmte, nom_mte, dir_mte,id_parroquia,tel_mte,email_mte,est_mte,gen_cmte) values ('" .$ci. "','" .$cmili. "','" .$nombre. "','" .$dir. "','" .$parr. "','" .$tel. "','" .$email. "','" .$est. "','" .$gen. "')"; 
